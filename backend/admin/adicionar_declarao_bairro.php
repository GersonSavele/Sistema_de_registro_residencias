                            ...
                            <div class="row">
                                <div class="col-lg-4 col-xl-4">
                                    <div class="card-box text-center">
                                        <img src="assets/images//<?php echo $row->ad_dpic;?>" class=" img-thumbnail"
                                            alt="profile-image">

                                        <h4 class="mb-0">Foto declaracao bairro</h4>
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                    <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle mr-1"></i> Adcionar Informacao pessoal e Declaracao Bairro</h5>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="useremail">Foto Declarcao de bairro</label>
