                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <h3>Volte novamente !</h3>

                                    <p class="text-muted font-13"> Logout feito com sucesso. </p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-red-50">Voltar ao <a href="index.php" class="text-red ml-1" style="color: red;"><b>LogIn</b></a> ou<a href="../../index.php" class="text-back ml-2 " style="color: red;"><b>Pagina Principal</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
