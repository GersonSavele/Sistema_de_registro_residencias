                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title"><?php echo $row->ad_fname;?> <?php echo $row->ad_lname;?>Perfil</h4>
                                    </div>
                                </div>
                            </div>
                            <!-- end page title -->
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-xl-4">
                                    <div class="card-box text-center">
                                        <img src="assets/images/users/<?php echo $row->ad_dpic;?>" class="fas fa-user-tag rounded-circle avatar-lg img-thumbnail"
                                            alt="profile-image">

                                        <h4 class="mb-0"><?php echo $row->ad_fname;?> <?php echo $row->ad_lname;?></h4>
                                        <p class="text-muted">@Sistema de Registro de Residências e Agregado Familiar </p>
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                    <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle mr-1"></i> Informacao Pessoal</h5>
                                                    <div class="row">
                                                        <div class="col-md-6">
