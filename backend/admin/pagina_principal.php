                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Sistema de Registro de Residências e Agregado Familiar</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    //code for summing up number of out proprietarios 
                                                    $result ="SELECT count(*) FROM proprietario_imovel ";
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Total proprietários registados</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                ...
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    $result ="SELECT count(*) FROM funcionario ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Total funcionários registados </p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM formulario ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Total formulários de agregado registados</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                ...
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    $result ="SELECT count(*) FROM talao_imposto ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Anexos</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
