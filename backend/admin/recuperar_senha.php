                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Informe o email que para pode receber as introcoes.</p>
                                </div>
                                ...
                                <form method="post" >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="email" type="email" id="emailaddress" required="" placeholder="Informe seu email">
                                    </div>

                                    <div class="form-group mb-0 text-center">
                                        <button name="reset_pwd" class="btn btn-primary btn-block" type="submit"> Recuparar Senha </button>
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p style="font-size:16px; color:orangered">Voltar para <a href="index.php" style="font-size:16px; color:black"><b>Login</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
